...
def collect_preference_data(model_name, colors, templates, exp_name=None):
    if exp_name is None:
    ...
    for i, template in enumerate(templates):
        ...
        df_results = collect_metrics_for_template(model, tokenizer, colors, template)
...
#         winner, prob_a, prob_b = get_scores_many_options(model, tokenizer, prompt, color_a, color_b)
#         results.append({
#             "item_a": color_a,
#             "item_b": color_b,
#             "prob_item_a": prob_a,
...
#         winner, prob_a, prob_b = get_perplexity_scores(model, tokenizer, prompt, color_a, color_b)
#         results.append({
#             "item_a": color_a,
#             "item_b": color_b,
#             "prob_item_a": prob_a,
