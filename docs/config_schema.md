...
```json
{
  ...
  "template_set": "options", "labels": ["Option 1", "Option 2"],
  "templates": { "0": "..." }, "timestamp": "20260804_142927"
}
```
...
| `labels` | **added 2026-08-18.** The answer strings whose last token is scored — `["1","2"]`, `["A","B"]`, `["Option 1","Option 2"]`. Bound to `template_set` (they have to agree), not chosen separately. Runs before this date have no key; they used the agent-class default for their family. |
